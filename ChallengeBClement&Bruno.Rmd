...
library(data.table)
```
link GIT: https://github.com/clementrx/Challenge-B/tree/1a115f51967056794f0415ec1dfc35aa86b07d00
...
train <- read.csv(file="/Users/clementrieux/Desktop/master/Rprogramming/challengeB/train.csv")   #We import both datasets : "train.csv" and "test.csv"
test <- read.csv(file="/Users/clementrieux/Desktop/master/Rprogramming/challengeB/test.csv")
...
# Problem of "levels" in the predictions
